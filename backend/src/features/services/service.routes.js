...
import { createService, getServices, getServiceById, updateService, updateServiceStatus, deleteService, } from "./service.controller.js";
...
router.delete("/:id", requireRole("SUPER_ADMIN", "SALON_ADMIN"), deleteService);
